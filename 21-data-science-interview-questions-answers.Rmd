---
title: "21 Must-Know Data Science Interview Questions and Answers"
...
See also the 2017 edition "17 More Must-Know Data Science Interview Questions and Answers".
...
This is most often done by adding a constant multiple to an existing weight vector. This constant is often either the L1 (Lasso) or L2 (ridge), but can in actuality can be any norm. 
...
![](regularization-lp-ball.jpg){width=100%}
...
![](precision-recall-relevant-selected.jpg){width=100%}
...
See also this Quora answer: What is the difference between a ROC curve and a precision-recall curve?.
...
![](116208-online-figure1.gif){width=100%}
